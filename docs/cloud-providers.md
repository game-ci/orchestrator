...
> **Standalone package**: These providers are part of [`@game-ci/orchestrator`](https://github.com/game-ci/orchestrator). Install the orchestrator package to use GCP Cloud Run or Azure ACI providers.
...
**Via CLI:**
```bash
npx game-ci orchestrate --providerStrategy gcp-cloud-run --gcpProject my-project --gcpBucket my-builds
```
...
**Via CLI:**
```bash
npx game-ci orchestrate --providerStrategy azure-aci --azureResourceGroup my-rg --azureStorageAccount mybuilds
```
