...
export function createBuildParametersFromCliOptions(options: Record<string, any>): BuildParameters {
  ...
  bp.lockedWorkspace = ''
  bp.cacheCheckpointInterval = Number(options.cacheCheckpointInterval) || 0
  ...
  bp.awsUseEphemeralStorage = options.awsUseEphemeralStorage === true || options.awsUseEphemeralStorage === 'true'
  ...
  bp.childWorkspacesEnabled = options.childWorkspacesEnabled === true || options.childWorkspacesEnabled === 'true'
  ...
  bp.childWorkspaceSeparateLibrary =
    options.childWorkspaceSeparateLibrary === true || options.childWorkspaceSeparateLibrary === 'true'
  ...
  bp.cleanReservedFilenames = options.cleanReservedFilenames === true || options.cleanReservedFilenames === 'true'
  bp.buildArchiveEnabled = options.buildArchiveEnabled === true || options.buildArchiveEnabled === 'true'
